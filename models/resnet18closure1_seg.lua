...
local function create_model_camvid(options)
    ...
    -- local block4 = sblock(nil, layer(block, 512, def[4], 2), upsamplingblock(512, 256))
    -- local block3 = sblock(block4, layer(block, 256, def[3], 2), upsamplingblock(256, 128))
    -- local block2 = sblock(block3, layer(block, 128, def[2], 2), upsamplingblock(128, 64))
